<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupMArchive.aspx.cs" Inherits="NocPortal.GroupMArchive" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>GroupM - Archive</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="row">
           <div class="col-md-2" style="display:inline-block">
            ...
            <div class="col-md-8">
                <h3 style="color:white; margin-left:35%">GroupM - Archive</h3>
                ...
                <div id="tableDiv">
                    <table class="table table-hover" id="tableContent"  style="text-align:center; margin-top:5%" runat="server">
